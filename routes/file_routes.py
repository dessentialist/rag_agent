...
def upload_file():
    ...
    try:
        ...
        # Save the file
        save_file(file_id, filename, file_type, content)
        
        # Process the file for RAG
        process_file_for_rag(file_id, filename, content, file_type)
...
def sync_knowledge_base():
    ...
    try:
        ...
        return jsonify({'error': 'An error occurred while retrieving Pinecone document information'}), 500
